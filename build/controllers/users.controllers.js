...
exports.auth = exports.deleteUser = exports.update = exports.getUser = exports.getAll = exports.create = void 0;
...
var getUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userModel.user(req.params.id)];
            case 1:
                user = _a.sent();
                res.json({
                    status: 'success',
...
var auth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, token, err_6;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, email = _a.email, password = _a.password;
                return [4 /*yield*/, userModel.auth(email, password)];
            case 1:
                user = _b.sent();
