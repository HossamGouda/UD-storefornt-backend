...
exports.deleteOrder = exports.updateOrder = exports.getoneOrder = exports.getAllOrders = exports.create = void 0;
...
var getAllOrders = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.getOrders()];
            case 1:
                orders = _a.sent();
                res.json({
                    status: 'success',
...
var getoneOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.getOneOrder(req.params.id)];
            case 1:
                order = _a.sent();
                res.json({
                    status: 'success',
