...
var createProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.createProduct(req.body)];
            case 1:
                product = _a.sent();
                res.json({
                    status: 'success',
...
var getAllProducts = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.getProducts()];
            case 1:
                products = _a.sent();
                res.json({
                    status: 'success',
                    data: __assign({}, products),
...
var getoneProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.getOneProduct(req.params.id)];
            case 1:
                product = _a.sent();
                res.json({
                    status: 'success',
