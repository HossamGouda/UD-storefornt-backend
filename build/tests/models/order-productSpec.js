...
describe('Order Product Model', function () {
    ...
    describe('Test Order Products Model logic', function () {
        ...
        it('Create method should return an order product', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderProductModel.create(orderProduct.quantity, orderProduct.productId, orderProduct.productId)];
                    case 1:
        ...
        it('Index method should return a list of products in a specific order', function () { return __awaiter(void 0, void 0, void 0, function () {
            var orderProducts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderProductModel.index(1)];
                    case 1:
        ...
        it('Show method should return the correct product in a specific order', function () { return __awaiter(void 0, void 0, void 0, function () {
            var targetOrderProduct;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderProductModel.show('1', '1')];
                    case 1:
                        targetOrderProduct = _a.sent();
        ...
        it('Edit method should return a order with edited properties', function () { return __awaiter(void 0, void 0, void 0, function () {
            var editOrderProduct;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderProductModel.edit({
                            id: 1,
                            quantity: 10,
                            orderId: '1',
                            productId: '1',
        ...
        it('Delete method should remove products from list of product in order', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderProductModel.delete(1, 1)];
                    case 1:
